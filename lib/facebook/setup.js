      ...
      return utils.apiGatewayPromise.getStagePromise({
        ...
        if (options['configure-fb-bot']) {
          ...
          .then(results => {
            ...
            deployment['variables'][pageAccessTokens[0].pageId] = pageAccessTokens[0].pageToken
            deployment['variables'][pageAccessTokens[1].pageId] = pageAccessTokens[1].pageToken
